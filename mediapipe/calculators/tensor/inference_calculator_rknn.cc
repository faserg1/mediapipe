...
class InferenceCalculatorRknnImpl
    : public InferenceCalculatorNodeImpl<InferenceCalculatorRknn,
                                         InferenceCalculatorRknnImpl> {
 public:
...
absl::Status InferenceCalculatorRknnImpl::UpdateContract(
...
absl::Status InferenceCalculatorRknnImpl::Open(CalculatorContext* cc) {
...
absl::StatusOr<std::vector<Tensor>> InferenceCalculatorRknnImpl::Process(
...
absl::Status InferenceCalculatorRknnImpl::Close(CalculatorContext* cc) {
  inference_runner_ = nullptr;
  return absl::OkStatus();
}

absl::StatusOr<std::unique_ptr<InferenceRunner>>
InferenceCalculatorRknnImpl::CreateInferenceRunner(CalculatorContext* cc) {
...
InferenceCalculatorRknnImpl::CreateDelegate(CalculatorContext* cc) {
